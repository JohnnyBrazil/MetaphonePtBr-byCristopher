...
/// <summary>
/// Metaphone is a text transformation algorithm based on phonetic rules of the Portuguese Brazilian language.
/// </summary>
public static class Metaphone
{
    /// <summary>
    /// Generates a metaphone token from the single word provided.
    /// </summary>
    /// <param name="word">A single word.</param>
    /// <returns>The generated metaphone token.</returns>
